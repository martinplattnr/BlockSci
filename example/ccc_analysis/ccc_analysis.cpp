...
int main(int argc, char * argv[]) {
    ...
    for (const auto &date : dates) {
        ...
        blocksci::Blockchain bch {"/mnt/data/blocksci/btc-bch/" + date + "/bch/config.json"};
        ...
        std::cout << "addressesMissingInScClustering=" << addressesMissingInScClustering << std::endl << std::endl << std::endl;
    }
